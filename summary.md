...
At any given time, different organisations are at different stages of their FAIR implementation journeys and benchmarking is challenging. While there are multiple FAIR data maturity models and metrics, there is no simple, agreed, maturity assessment model of FAIR data principle implementation at the organisational level for life-science organisations. The Pistoia Alliance [FAIR implementation project](https://www.pistoiaalliance.org/projects/current-projects/fair-implementation/) set out to design a FAIR maturity matrix in 2023. This document presents the first version of the FAIR maturity matrix, an organisational maturity model of FAIR implementation.

## **Who created the FAIR maturity matrix?**

From February 2023 to April 2024, [over 20 experts](https://pistoiaalliance.atlassian.net/wiki/x/HwC6y) from AstraZeneca, Bristol Myers Squibb, CSL Behring, Curlew Research, Elsevier, Elixir Europe, Exponent AI, FAQIR Foundation, GO FAIR Foundation, IQVIA, Novo Nordisk, Ontoforce, The Hyve, and the Pistoia Alliance contributed to the FAIR maturity matrix documents.
...
The structure of this first model is a matrix. Each matrix element has to be seen in relation not only to its nearest neighbours for the “maturity axis” but also with all the elements in the same level, or the “dimensions axis”. That should, in turn, indicate concrete directions for improvement.
...
If you are interested in the FAIR Maturity Matrix, please contact: [fair-maturity-matrix@pistoiaalliance.org](mailto:fair-maturity-matrix@pistoiaalliance.org)  
